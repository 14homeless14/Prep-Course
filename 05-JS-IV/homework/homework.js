...
function invocarMetodo(objeto, metodo) {
  // "metodo" es una cadena (es un string) que contiene el nombre  de un método (funcion) en el objeto
  // Invoca ese método
...
function sumarLikesDeUsuario(usuario) {
  ...
  // Tu código:
  //usuario={posts: }
  //posts[post0,post1,post2,post3]-------post={likes: int}
  suma=0;
  for (let index = 0; index < usuario.posts.length; index++) {
  suma1 = usuario.posts[index].likes;
  suma = suma + suma1;
  }
  return suma;
}
